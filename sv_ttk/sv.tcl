...
font create SunValleyCaptionFont -family "Chakra Petch$static Small" -size -12
font create SunValleyBodyFont -family "Chakra Petch$static Text" -size -14
font create SunValleyBodyStrongFont -family "Chakra Petch$static Text Semibold" -size -14
font create SunValleyBodyLargeFont -family "Chakra Petch$static Text" -size -18
font create SunValleySubtitleFont -family "Chakra Petch$static Display Semibold" -size -20
font create SunValleyTitleFont -family "Chakra Petch$static Display Semibold" -size -28
font create SunValleyTitleLargeFont -family "Chakra Petch$static Display Semibold" -size -40
font create SunValleyDisplayFont -family "Chakra Petch$static Display Semibold" -size -68
