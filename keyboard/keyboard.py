...
class KeyBoard(Tk.Toplevel):
    ...
    def createPad(self, currentWidget):
        ...
        self.labelkey1 = Tk.LabelFrame(self.labelFrame, text=_("Input"), bg='white', font="Times 25", borderwidth=0)
        self.labelkey1.grid(column=0, row=7, sticky="nw", padx=0, pady=0)
        self.entry_content = Tk.Label(self.labelkey1, text=" ", fg="black", bg="white", font="Times 43")
        self.entry_content.grid(row=0, column=0, columnspan=13, padx=0, pady=5, sticky="sw")
        labelkey2 = Tk.Label(self.labelkey1, text=" ", bg='white', fg="white", font="Verdana 14")
