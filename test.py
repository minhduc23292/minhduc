...
# batery.seal()
# batery.fullAcess()
# batery.toggle_the_charge_fet()
# batery.change_temperature_sensor_to_internal()
# tem=batery.read_temperature_enable_flash()
# print(tem)
# batery.enable_gauge()
# operation_status=batery.read_operation_status()
# charging_status=batery.read_charging_status()
# manu=batery.read_manufactoring_status()
# gau=batery.read_gauging_status()
# print("op=", operation_status)
# print("charge: ", charging_status)
# print("manu:", manu)
# print("gau:", gau)
